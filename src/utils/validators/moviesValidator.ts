...
export const validateCreate = [
  ...
  check("genero")
    //isIn de Express Validator para asegurarse de que el valor proporcionado para el campo genero se encuentre en los valores 
    //permitidos definidos en el enum Genero. Si el valor no está en la lista de valores permitidos, se devolverá un mensaje de error.
    .notEmpty()
